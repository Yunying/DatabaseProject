...
public class AddWindow extends JPanel implements ActionListener{
	...
	public AddWindow(String s){
		...
		else if (s == "invoice_from_vendor"){
			addAnInvoice(1);
		}
		else if (s == "invoice_to_client"){
			addAnInvoice(2);
		}
	...
	public void addAnInvoice(int a){
		//Table
...
//		JTable table = new JTable(model);
	...
	public void addACompany(){
		//Major Inputs
		inputs = new JPanel();
		inputs.setLayout(new GridLayout(6,2,10,10));
